    ...
    switch (fBitmap->config()) {
        case SkBitmap::kIndex8_Config:
            ...
            if (SI8_opaque_D32_filter_DX == fSampleProc32) {
                if (clamp_clamp) {
                    fShaderProc32 = (SkBitmapProcState::ShaderProc32)Clamp_SI8_opaque_D32_filter_DX_shaderproc;
                } else if ((SkShader::kRepeat_TileMode == fTileModeX) &&
                           (SkShader::kRepeat_TileMode == fTileModeY)) {
                    fShaderProc32 = (SkBitmapProcState::ShaderProc32)Repeat_SI8_opaque_D32_filter_DX_shaderproc;
                }
            } else
#endif
#if __ARM_ARCH__ >= 6 && !defined(SK_CPU_BENDIAN)
        ...
        case SkBitmap::kARGB_8888_Config:
            ...
            if (S32_opaque_D32_filter_DX == fSampleProc32 && clamp_clamp) {
                fShaderProc32 = (SkBitmapProcState::ShaderProc32)Clamp_S32_opaque_D32_filter_DX_shaderproc;
            } else if (S32_opaque_D32_nofilter_DX == fSampleProc32 && clamp_clamp) {
                fShaderProc32 = (SkBitmapProcState::ShaderProc32)Clamp_S32_opaque_D32_nofilter_DX_shaderproc;
            }
#endif
            break;
        default:
